...
textAreaElement.keyup(function() {
    let textEnteredLength = textAreaElement.val().length;
    let textEntered = textAreaElement.val();
    let originalText = originalTextElement.text().trim();
    ...
    if(textEntered === ''){
        ...
        if(textEntered === originalText){
            ...
            if(textEntered === partialText){
                ...
                messageCard.removeClass('bg-success').removeClass('bg-primary')
                    .removeClass('bg-light').addClass('bg-danger');
                message.text('Wrong !!');
